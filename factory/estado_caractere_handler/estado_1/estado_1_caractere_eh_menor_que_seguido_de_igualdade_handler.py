...
#
# O arquivo estado_1_caractere_eh_menor_que_seguido_de_igualdade_handler.py comporta o "handle" de quando o analisadoir lexico está no
...
class Estado1CaractereEhMenorQueSeguidoDeIgualdadeHandler:
    """
    ...
    def caractere_matches(self, motor_lexico, caractere):
        ...
        :return: booleando
        """
        return caractere == Constants.MENOR_QUE and motor_lexico.prox_char() == Constants.IGUAL
