...
#
# O arquivo estado_1_caractere_eh_invalido_handler.py comporta o "handle" de quando o analisadoir lexico está no
# estado 1 e o caractere é inválido
#
...
class Estado1CaractereEhInvalidoHandler:
    ...
    def handle(self, caractere, motor_lexico, set_novo_estado):
        ...
        """
        return Token(motor_lexico.linha, TipoToken.ERROR, '[' + caractere + ']', 'Caractere inválido: ' + caractere)
