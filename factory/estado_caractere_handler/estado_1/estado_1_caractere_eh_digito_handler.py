...
#
# O arquivo estado_1_caractere_eh_digito_handler.py comporta o "handle" de quando o analisadoir lexico está no
# estado 1 e o caractere é dígito
#
...
class Estado1CaractereEhDigitoHandler:
    """
    Handler do caractere do estado 1 da análise léxica, o qual verifica se o caractere é um dígito
    """
